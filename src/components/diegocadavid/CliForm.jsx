		...
		<div className='bg-slate-100 p-3'>
			<form className=' flex flex-col gap-3 items-center' onSubmit={handleSubmit}>
				...
				<p className='text-sm text-center text-zinc-400'>
					Accede a mas configuraciones desde la terminal ;)
				</p>
				<button
					type='submit'
					className='group ring-1 bg-slate-100 hover:bg-sky-100 ring-slate-500/40 hover:ring-sky-600/40 ring-offset-2 mt-4 p-3 transition-colors ease-linear rounded-sm relative'
				>
