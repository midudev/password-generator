...
function PGApp() {
	...
	return (
		<AppContext.Provider value={{ state, setState }}>
			...
			<main className='flex selection:bg-[#b4ff39] selection:text-[#170f1e] justify-center items-center flex-col h-screen main-eg mx-auto w-screen p-5'>
				<header className=''>
					<a
						href='/'
						className='group header-logo-eg fixed font-mono  top-14 h-5 left-5 saturate-50 flex items-center text-white gap-4 hover:saturate-100'
					>
						<img src={logoHack.src} alt='Logo hacktober fest' width={50} />
						<h1 className='tracking-wide	text-lg shadow-eg'>HACKTOBERFEST</h1>
					</a>
				</header>
				<section className='flex justify-center mt-20 md:mt-10 items-center flex-col w-full'>
