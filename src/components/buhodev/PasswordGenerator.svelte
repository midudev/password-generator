...
<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white rounded-lg">
	...
	<div class="flex items-center justify-center mt-8 w-full">
		...
		<button title="Copy password" class="rounded-md border-2 border-slate-700 hover:border-slate-600 flex items-center justify-center py-1 px-2">
		...
		<button title="Refresh password" class="rounded-md border-2 border-slate-700 hover:border-slate-600 flex items-center justify-center py-1 px-2">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
