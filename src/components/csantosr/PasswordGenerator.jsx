...
const PasswordGenerator = () => {
	...
	const onlyOne = useMemo(
		() => [useNumbers, useLower, useUpper, useSpecial].filter((a) => a).length === 1,
		[useNumbers, useLower, useUpper, useSpecial]
	)
		...
		<div className='flex justify-center items-center h-screen'>
			<div className='p-5 bg-gray-600 rounded-lg w-1/3'>
				...
				<div className='flex my-2'>
					...
					/>
					<button
						className='inline-flex items-center px-3 text-sm text-gray-900 bg-gray-800 rounded-r-md'
						type='button'
