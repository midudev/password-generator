	...
	<div class="min-h-screen min-w-full flex">
		<div class="border rounded bg-white m-auto w-11/12 sm:w-8/12 md:w-6/12 p-5">
			...
			<div class="my-3 relative">
				...
				<div
					@click="copyText"
					class="absolute bg-gray-50 rounded top-[20%] right-1 text-gray-300 hover:text-gray-500 cursor-pointer"
					v-if="password !== ''"
				>
					<svg
			...
			<div class="my-4">
				...
				<div class="my-2">
					<button
						...
						class="bg-blue-600 text-white text-center w-full rounded p-2"
					>
						Generate password
					</button>
					<p
						v-else
						class="bg-red-200 border border-red-600 text-center text-red-500 w-full rounded p-2"
					>
...
export default {
	...
	data() {
		return {
			removeCharacters: [
				33, 34, 39, 40, 41, 42, 43, 44, 45, 46, 47, 58, 59, 60, 61, 62, 63, 64, 91, 92, 93, 94, 95,
				96
			],
			checkboxDetails: {
				uppercase: {
