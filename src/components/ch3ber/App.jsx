	...
	return (
		<>
			<main className="text-[#E5E1E6] text-center pt-20 bg-squares bg-[url('./assets/grain-dark-background.png')]" >
				...
				<h1 className='mt-20 text-3xl text-white font-black text-shadow'>Random password generator</h1>

				<div className='mt-8 mb-6 flex gap-10 items-center justify-center'>
					<input type='text' value={password} className='bg-transparent border-b-2 border-white' disabled />
				...
				<button className='hacktoberfest-btn w-80' onClick={hanldeClick}>Generate password</button>

				<section className='mt-20'>
					<h2 className='text-xl font-bold'>[ Configure your password ]</h2>
					<div className='mt-5 flex items-center justify-center gap-5'>
						<p>Password length = {range}</p>
						<input type='range' defaultValue={DEFAULT_PASSWORD_LENGTH} min='6' max='50' onChange={hanldeSetRange} />
					</div>
				</section>
			</main>
			<Footer />
