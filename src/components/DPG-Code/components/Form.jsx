		...
		<div className='gameboy h-[480px] w-[288px] flex items-center justify-center relative   sm:h-[600px] sm:w-[361px]'>
			...
			>
				{start ? (
					...
					<>
						<h1 className='mt-3 mb-5 text-xs text-[#294409] text-center   sm:text-base'>
							Password Generator
						</h1>
						{label ? (
							<div className='z-10 text-lime-900 text-[10px] absolute top-[30px] right-[68.8px] opacity-75   sm:top-[38px] sm:right-[86px] sm:text-xs'>
								Copied!
							</div>
						) : (
							''
