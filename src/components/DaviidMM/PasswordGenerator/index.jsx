...
const PasswordGenerator = () => {
	...
	return (
		<div className='w-full p-4 rounded-3xl text-xl bg-white flex flex-col items-center gap-4'>
			...
			{password && (
				<div className='rounded-xl bg-purple-300 flex flex-row overflow-hidden items-stretch w-[500px]'>
					<ColoredText className='text-3xl font-semibold px-4 py-2 w-full overflow-hidden text-ellipsis whitespace-nowrap'>
						{password}
					</ColoredText>
					<button
						className='px-4 py-2 bg-purple-500 text-white transition-colors hover:bg-purple-600'
