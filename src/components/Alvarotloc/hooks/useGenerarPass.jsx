...
const useGenerarPass = () => {
  ...
  const generarPassword = () => {
    ...
    for (let i = 0; i < longitud; i++) {
      let finalOption =
        opcionesAUsar[Math.floor(Math.random() * opcionesAUsar.length)];
      generatedPassword +=
        finalOption[Math.floor(Math.random() * finalOption.length)];
    }
  ...
  const INPUTS_INFORMATION = [
    { for: "uppercase", value: incluirMayus , setvalue : setIncluirMayus, text : 'Incluir letras mayúsculas' },
    { for: "lowercase", value: incluirMinus , setvalue : setIncluirMinus, text : 'Incluir letras minúsculas' },
    { for: "numbers", value: incluirNumeros , setvalue : setIncluirNumeros, text : 'Incluir números' },
    { for: "symbols", value: incluirSimbolos, setvalue : setIncluirSimbolos, text : 'Incluir símbolos' },
  ];
