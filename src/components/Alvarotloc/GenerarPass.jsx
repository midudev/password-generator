...
const GenerarPass = () => {
	...
	return (
		<main className='h-screen bg-slate-900 flex flex-col items-center p-10 space-y-4'>
			<h1 className='text-white text-center text-2xl font-semibold'>G3N3R4T3 P4SSW0RD</h1>
			...
			<section className='bg-slate-700 w-80 md:w-2/5 md:min-w-max  px-5 py-5 rounded flex flex-col space-y-4'>
				...
				<button
					...
					disabled={
						![incluirMayus, incluirMinus, incluirNumeros, incluirSimbolos, usingDate].includes(true)
					}
